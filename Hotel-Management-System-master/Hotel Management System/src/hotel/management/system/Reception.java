...
public class Reception extends JFrame {
	...
	private JLabel paradiseLabel;
	private JLabel paradiseLabel2;
	...
	public Reception(){
		...
		paradiseLabel2 = new JLabel("HOTEL BLUE MOON");
		paradiseLabel2.setFont(new Font("Segoe UI", Font.PLAIN, 80));
		paradiseLabel2.setForeground(Color.gray); // Set text color to black
		paradiseLabel2.setBounds(400, 370, 1000, 120);
		contentPane.add(paradiseLabel2);

		paradiseLabel = new JLabel("One step closer to Paradise");
		paradiseLabel.setFont(new Font("Segoe UI", Font.PLAIN, 50));
		paradiseLabel.setForeground(Color.WHITE); // Set text color to white
		paradiseLabel.setBounds(400, 340, 1000, 300);
		contentPane.add(paradiseLabel);


		ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/reception_2.jpg"));
                Image i3 = i1.getImage().getScaledInstance(950, 557,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(208,3,1000,557);
                add(l1);
